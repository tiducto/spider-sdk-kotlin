...
import cz.davidkurzica.client.RouteLocation as CoreRouteLocation
 ...
 *
 * The rich Kotlin API in commonMain (`cz.davidkurzica.client`: sealed RouteLocation/RouteTime,
