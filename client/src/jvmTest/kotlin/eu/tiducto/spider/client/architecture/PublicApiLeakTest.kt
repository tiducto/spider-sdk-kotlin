 ...
 * (e.g. a future codegen output package under `eu.tiducto.spider.client.`),
 ...
 * `:contract` module (package `eu.tiducto.spider.contract.*`, consumed as an
